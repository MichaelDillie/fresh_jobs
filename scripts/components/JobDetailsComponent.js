	...
	render: function() {
		return(
			<div className="JobDetails">
				<div className="title">Junior Frontend Dev</div>
				<div>
					<span className="company">ESO Solutions •</span>
				...
				Praesent convallis tincidunt mauris ac malesuada. Mauris venenatis tincidunt orci et dapibus.
				Morbi cursus urna sit amet lacus posuere ornare. Cras pharetra enim mauris, vel varius metus pulvinar tempus.
				Sed mollis, erat sed aliquam ultrices, lorem ligula pretium ipsum, ac gravida quam leo eget dui.
				Quisque sed nulla in dolor scelerisque aliquam. Duis congue, libero pretium dictum consequat, mi urna mollis tellus, vel interdum quam tellus non velit.
				Donec eget congue odio, ut laoreet arcu. Aenean vitae purus faucibus, blandit ante at, convallis lacus.
				...
				Etiam aliquam sapien ac turpis blandit fermentum. Praesent ac felis vel magna pretium vulputate.
				Nam maximus sem non accumsan imperdiet. Aliquam erat volutpat. Mauris pharetra tortor at lacus sagittis mollis.
				Nulla scelerisque porttitor pharetra.
				</div>
			</div>
		)
	}
